      ...
      const rowsHtml = table.columns
        .map((col) => {
          ...
          const fkBadge = col.isFk
            ? `<span class="badge fk-badge">FK${col.fkTarget ? ` &rarr; ${col.fkTarget}` : ""}</span>`
            : "";
          return `
            <tr>
              ...
              <td class="col-type-cell"><code>${col.type || "text"}</code></td>
    ...
    <div class="report-page data-dictionary-page">
      ...
      <div class="report-header">
        <div class="report-title-group">
          ...
          <p class="report-subtitle font-mono">Database: <strong>${dbName}</strong> &bull; Generated by dodb Studio</p>
        </div>
